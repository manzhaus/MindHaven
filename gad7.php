...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($score <= 4) {
        ...
        $suggestions = "<ul>
            <li>Great job managing stress! Keep up your healthy coping habits.</li>
            <li>Stay active and connected with your support network.</li>
            <li>Check out daily mental health tips in the app.</li>
        </ul>";
    } elseif ($score <= 9) {
        $interpretation = "Mild anxiety";
        $suggestions = "<ul>
            <li>Practice regular relaxation techniques like deep breathing or yoga.</li>
            <li>Try journaling to process your worries.</li>
            <li>Explore calming resources available in the app.</li>
        </ul>";
    } elseif ($score <= 14) {
        $interpretation = "Moderate anxiety";
        $suggestions = "<ul>
            <li>It may help to speak with a counsellor about your anxiety.</li>
            <li>Use the app's anonymous chat support for immediate conversation.</li>
            <li>Stay consistent with self-care and sleep routines.</li>
        </ul>";
    } else {
        $interpretation = "Severe anxiety";
        $suggestions = "<ul>
            <li>We strongly suggest connecting with a mental health professional.</li>
            <li>Start a conversation using the in-app secure chat feature.</li>
            <li>You're not alone. Help is available and things can improve.</li>
        </ul>";
    }
    ...
    if (isset($_SESSION['user_id'])) {
        ...
        $stmt = $conn->prepare("INSERT INTO gad7_history (user_id, score, interpretation) VALUES (?, ?, ?)");
...
<head>
    ...
    <title>GAD-7 Assessment - MindHaven</title>
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.0.0-beta3/css/all.min.css">
    <style>
        /* MindHaven GAD-7 Assessment - Enhanced UI */
        /* Using the clinical orange theme */

        /* Color Variables - Clinical Orange Theme */
        :root {
        ...
        * {
        ...
        .sidebar {
            ...
            z-index: 1000;
            box-shadow: 3px 0 15px rgba(255, 140, 66, 0.15);
            display: flex;
        ...
        /* Header */
        .header {
            background: linear-gradient(135deg, #fff8f0, #ffe5d9, #f5f3ff);
            color: var(--deep-navy);
            padding: 2rem;
            text-align: center;
            position: relative;
        ...
        .header::before {
            ...
            width: 100%;
            height: 100%;
            background: url("data:image/svg+xml,%3Csvg width='100' height='100' viewBox='0 0 100 100' xmlns='http://www.w3.org/2000/svg'%3E%3Cpath d='M11 18c3.866 0 7-3.134 7-7s-3.134-7-7-7-7 3.134-7 7 3.134 7 7 7zm48 25c3.866 0 7-3.134 7-7s-3.134-7-7-7-7 3.134-7 7 3.134 7 7 7zm-43-7c1.657 0 3-1.343 3-3s-1.343-3-3-3-3 1.343-3 3 1.343 3 3 3zm63 31c1.657 0 3-1.343 3-3s-1.343-3-3-3-3 1.343-3 3 1.343 3 3 3zM34 90c1.657 0 3-1.343 3-3s-1.343-3-3-3-3 1.343-3 3 1.343 3 3 3zm56-76c1.657 0 3-1.343 3-3s-1.343-3-3-3-3 1.343-3 3 1.343 3 3 3zM12 86c2.21 0 4-1.79 4-4s-1.79-4-4-4-4 1.79-4 4 1.79 4 4 4zm28-65c2.21 0 4-1.79 4-4s-1.79-4-4-4-4 1.79-4 4 1.79 4 4 4zm23-11c2.76 0 5-2.24 5-5s-2.24-5-5-5-5 2.24-5 5 2.24 5 5 5zm-6 60c2.21 0 4-1.79 4-4s-1.79-4-4-4-4 1.79-4 4 1.79 4 4 4zm29 22c2.76 0 5-2.24 5-5s-2.24-5-5-5-5 2.24-5 5 2.24 5 5 5zM32 63c2.76 0 5-2.24 5-5s-2.24-5-5-5-5 2.24-5 5 2.24 5 5 5zm57-13c2.76 0 5-2.24 5-5s-2.24-5-5-5-5 2.24-5 5 2.24 5 5 5zm-9-21c1.105 0 2-.895 2-2s-.895-2-2-2-2 .895-2 2 .895 2 2 2zM60 91c1.105 0 2-.895 2-2s-.895-2-2-2-2 .895-2 2 .895 2 2 2zM35 41c1.105 0 2-.895 2-2s-.895-2-2-2-2 .895-2 2 .895 2 2 2zM12 60c1.105 0 2-.895 2-2s-.895-2-2-2-2 .895-2 2 .895 2 2 2z' fill='%23FF8C42' fill-opacity='0.06' fill-rule='evenodd'/%3E%3C/svg%3E");
            opacity: 0.8;
            z-index: 0;
        }
        ...
        .assessment-header {
            ...
            text-align: center;
            background: linear-gradient(135deg, rgba(255, 140, 66, 0.05), rgba(139, 95, 191, 0.05));
        }
...
<body>
    ...
    <div class="main-wrapper">
        <!-- Header -->
        <header class="header">
            <h1 class="page-title">GAD-7 Anxiety Assessment</h1>
            <p class="page-subtitle">Generalized Anxiety Disorder - 7 Questions</p>
        </header>
            ...
            <div class="assessment-container">
                <?php if ($score === null): ?>
                    ...
                    <div class="assessment-header">
                        ...
                        <h2 class="assessment-title">Anxiety Screening</h2>
                    ...
                    <div class="progress-container" id="progressContainer">
                        ...
                        <div class="progress-text" id="progressText">Question 0 of 7</div>
                    </div>
                ...
                <?php else: ?>
                    ...
                    <div class="results-container">
                        ...
                        <div class="score-display"><?= $score ?>/21</div>
                        <div class="interpretation"><?= $interpretation ?></div>
                        
                        <div class="suggestions">
                            <h3><i class="fas fa-lightbulb" style="margin-right: 0.5rem; color: var(--primary-orange);"></i>Recommendations</h3>
                            <?= $suggestions ?>
                        </div>
