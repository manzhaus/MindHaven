...
if (isset($_SESSION['user_id'])) {
    ...
    // Get GAD-7 history
    $sql = "SELECT score, interpretation, date_taken FROM gad7_history WHERE user_id = ? ORDER BY date_taken ASC";
...
if ($hasHistory) {
    foreach ($history as $record) {
        ...
        if ($score <= 4) {
            $colors[] = '#27AE60'; // Minimal anxiety - green
        } elseif ($score <= 9) {
            $colors[] = '#FF8C42'; // Mild anxiety - orange
        } elseif ($score <= 14) {
            $colors[] = '#F39C12'; // Moderate anxiety - amber
        } else {
            $colors[] = '#E74C3C'; // Severe anxiety - red
        }
    }
}
?>
...
<head>
    ...
    <title>GAD-7 History - MindHaven</title>
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.0.0-beta3/css/all.min.css">
    <script src="https://cdn.jsdelivr.net/npm/chart.js"></script>
    <style>
        /* MindHaven GAD-7 History - Clinical Orange Theme */
        ...
        * {
        ...
        .score-mild { background-color: var(--primary-orange); }
        .score-moderate { background-color: var(--warning-amber); }
        .score-severe { background-color: var(--error-crimson); }
        ...
        .no-history-icon {
            ...
            height: 120px;
            border-radius: 50%;
            background: linear-gradient(135deg, rgba(255, 140, 66, 0.1), rgba(139, 95, 191, 0.1));
            display: flex;
            align-items: center;
            justify-content: center;
            margin: 0 auto 2rem;
...
<body>
    ...
    <div class="main-wrapper">
        <!-- Header -->
        <header class="header">
            <h1 class="page-title">GAD-7 Assessment History</h1>
            <p class="page-subtitle">Track your anxiety assessment progress over time</p>
        </header>
        ...
        <main class="main-content">
            <div class="history-container">
                <div class="history-header">
                    ...
                    <h2 class="history-title">Your GAD-7 Progress</h2>
                    <p class="history-description">
                        Monitor your mental health journey with detailed tracking of your GAD-7 anxiety assessments
                    </p>
                </div>
                ...
                <?php if (!$hasHistory): ?>
                    <div class="no-history">
                        ...
                        <p class="no-history-text">
                            You haven't taken any GAD-7 assessments yet. Start your mental health tracking journey by taking your first assessment.
                        </p>
                        <a href="gad7.php" class="start-assessment-btn">
                            <i class="fas fa-play"></i>
                            Take Your First GAD-7 Assessment
                        </a>
                    </div>
                <?php else: ?>
                    <!-- Chart Section -->
